...
def get_locationData(lat,lon,loc):
    ...
    #url = 'https://discover.search.hereapi.com/v1/discover?in=circle:19.1334,72.9133;r=10000&q=apartment&apiKey=G-eCLqMiE-bnD1fwAdwSRfD3JIoyyaezfY21hYoDzH0'
    url = f'https://discover.search.hereapi.com/v1/discover?in=circle:{lat},{lon};r=10000&q=apartment&apiKey=G-eCLqMiE-bnD1fwAdwSRfD3JIoyyaezfY21hYoDzH0'
    ...
    for lat, lng in zip(latitudes, longitudes):    
        ...
        url = 'https://discover.search.hereapi.com/v1/discover?in=circle:{},{};r={}&q={}&apiKey=G-eCLqMiE-bnD1fwAdwSRfD3JIoyyaezfY21hYoDzH0'.format(latitude, longitude, radius, search_query)
